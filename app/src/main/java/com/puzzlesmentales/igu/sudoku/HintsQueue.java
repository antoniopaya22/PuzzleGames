...
public class HintsQueue {
	...
	public HintsQueue(Context context) {
		...
		mHintDialog = new AlertDialog.Builder(context,AlertDialog.THEME_HOLO_DARK).setIcon(R.drawable.ic_launcher_background).setTitle("Hola").setMessage("")
				.setPositiveButton("Ok", mHintClosed).create();
