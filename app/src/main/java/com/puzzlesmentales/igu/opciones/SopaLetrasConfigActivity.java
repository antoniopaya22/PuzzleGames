...
import com.puzzlesmentales.igu.sopa.JugarSopaConfigFragment;
import com.puzzlesmentales.igu.sopa.LeerSopaConfigFragment;


public class SopaLetrasConfigActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_sopa_letras,menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position)
        {
            ...
            switch (position) {
                case 0:
                    fragmento = new JugarSopaConfigFragment();
                    break;
                case 1:
                    fragmento = new LeerSopaConfigFragment();
                    break;
            }
            return fragmento;
        }
